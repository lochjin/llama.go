...
func TestManifests(t *testing.T) {
	cases := map[string]struct {
		...
		"multiple": {
			ps: []string{
				filepath.Join("registry.llamago.ai", "library", "llama3", "latest"),
				filepath.Join("registry.llamago.ai", "library", "llama3", "q4_0"),
				filepath.Join("registry.llamago.ai", "library", "llama3", "q4_1"),
				filepath.Join("registry.llamago.ai", "library", "llama3", "q8_0"),
				filepath.Join("registry.llamago.ai", "library", "llama3", "q5_0"),
				filepath.Join("registry.llamago.ai", "library", "llama3", "q5_1"),
				filepath.Join("registry.llamago.ai", "library", "llama3", "q2_K"),
				filepath.Join("registry.llamago.ai", "library", "llama3", "q3_K_S"),
				filepath.Join("registry.llamago.ai", "library", "llama3", "q3_K_M"),
				filepath.Join("registry.llamago.ai", "library", "llama3", "q3_K_L"),
				filepath.Join("registry.llamago.ai", "library", "llama3", "q4_K_S"),
				filepath.Join("registry.llamago.ai", "library", "llama3", "q4_K_M"),
				filepath.Join("registry.llamago.ai", "library", "llama3", "q5_K_S"),
				filepath.Join("registry.llamago.ai", "library", "llama3", "q5_K_M"),
				filepath.Join("registry.llamago.ai", "library", "llama3", "q6_K"),
			},
			wantValidCount: 15,
		},
		"hidden": {
