...
// Only llama.go supported types are considered valid
...
const (
	...
	TensorTypeQ6_K
	TensorTypeQ8_K
	tensorTypeIQ2_XXS // not supported by llama.go
	tensorTypeIQ2_XS  // not supported by llama.go
	tensorTypeIQ3_XXS // not supported by llama.go
	tensorTypeIQ1_S   // not supported by llama.go
	tensorTypeIQ4_NL  // not supported by llama.go
	tensorTypeIQ3_S   // not supported by llama.go
	tensorTypeIQ2_S   // not supported by llama.go
	tensorTypeIQ4_XS  // not supported by llama.go
	TensorTypeI8
	TensorTypeI16
	TensorTypeI32
	TensorTypeI64
	TensorTypeF64
	tensorTypeIQ1_M // not supported by llama.go
	TensorTypeBF16
	tensorTypeQ4_0_4_4   // unused by GGML
	tensorTypeQ4_0_4_8   // unused by GGML
	tensorTypeQ4_0_8_8   // unused by GGML
	tensorTypeTQ1_0      // not supported by llama.go
	tensorTypeTQ2_0      // not supported by llama.go
